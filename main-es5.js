      ...
      _createClass(CarAddComponent, [{
        ...
        value: function submit() {
          ...
          this.carService.addCar(this.form.value).subscribe(function (car) {
            ...
            _this2.notificationService.text = 'Авто добавлено!';
            _this2.notificationService.showBox = 'on';

            _this2.form.reset();
          }, function (error) {
            _this2.error = error.error.message;
            _this2.notificationService.text = error.error.message;
            _this2.notificationService.showBox = 'on';

            _this2.notificationService.offShow();
      ...
      _createClass(CarComponent, [{
          ...
          this.route.params.subscribe(function (params) {
            _this3.sub = _this3.carService.getByNumber(params.number).subscribe(function (car) {
              ...
              if (car) {
                ...
                _this3.comments = _this3.car.comments;
              }
            });
          });
        }
        ...
        value: function save() {
          ...
          this.carService.updateCar(this.car.number, this.comments, data).subscribe(function (car) {
            _this4.car = car;
            _this4.notificationService.text = 'Информация обновлена!';
            _this4.notificationService.showBox = 'on';
            _this4.edit = false;
          }, function (error) {
            _this4.notificationService.text = error.error.message;
            _this4.notificationService.colorError = true;
            _this4.notificationService.showBox = 'on';
            _this4.carService.updating = false;

            _this4.notificationService.offShow();
          }, function () {
            _this4.carService.updating = false;
        ...
        value: function _delete() {
          ...
          this.carService.deleteCar(this.car.number).subscribe(function (res) {
            _this5.notificationService.text = 'Автомобиль удален!';
            _this5.notificationService.showBox = 'on';

            _this5.carService.deleteByNumber(_this5.car.number);

            _this5.router.navigate(['/cars']);
          }, function (error) {
            _this5.edit = false;
            _this5.notificationService.colorError = true;
            _this5.notificationService.showBox = 'on';
            _this5.notificationService.text = error.error.message;
            _this5.carService.deleting = false;
            _this5.deleteMode = false;

            _this5.notificationService.offShow();
          }, function () {
            _this5.carService.deleting = false;
            _this5.deleteMode = false;
    ...
    var UserService = /*#__PURE__*/function () {
      ...
      _createClass(UserService, [{
        ...
        value: function getById(id) {
          ...
          return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observable) {
            setInterval(function () {
              observable.next(_this9.users.find(function (user) {
                return user._id === id;
              }));
            }, 100);
          });
      ...
      _createClass(UserAddComponent, [{
        ...
        value: function submit() {
          ...
          this.userService.userRegister(this.form.value).subscribe(function (user) {
            _this10.userService.addUserToState(user);

            _this10.notificationService.text = 'Пользователь создан!';
            _this10.notificationService.showBox = 'on';

            _this10.form.reset();
          }, function (error) {
            _this10.notificationService.text = error.error.message;
            _this10.notificationService.showBox = 'on';
            _this10.userService.registering = false;

            _this10.notificationService.offShow();
          }, function () {
            _this10.userService.registering = false;
    ...
    var UserComponent = /*#__PURE__*/function () {
      ...
      _createClass(UserComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.params.subscribe(function (params) {
            _this11.sub = _this11.userService.getById(params.id).subscribe(function (user) {
              if (user) {
                _this11.user = user;
                _this11.login = user.login;
                _this11.name = user.name;

                _this11.sub.unsubscribe();
              }
            });

            _this11.shiftService.getShifts(params.id).subscribe(function (shifts) {
              _this11.shiftService.shifts = shifts;
              _this11.shiftService.loading = false;
            });
          });
        }
      }, {
        ...
        value: function deleteShift() {
          ...
          this.shiftService.deleteShifts(this.user._id, this.checkedShift).subscribe(function (shifts) {
            _this12.shiftService.shifts = shifts;
            _this12.shiftService.deleting = false;
          });
        }
      }, {
        key: "sumData",
        ...
        value: function submit(data) {
          ...
          this.userService.updateUser(data).subscribe(function (user) {
            _this13.user = user;
            _this13.notificationService.text = 'Пользователь обновлен!';
            _this13.notificationService.showBox = 'on';
          }, function (error) {
            _this13.notificationService.text = error.error.message;
            _this13.notificationService.colorError = true;
            _this13.notificationService.showBox = 'on';
            _this13.userService.updating = false;

            _this13.notificationService.offShow();
          }, function () {
            _this13.userService.updating = false;
        ...
        value: function deleteUser() {
          ...
          this.userService.deleteUser(this.user._id).subscribe(function () {
            _this14.userService.deleteUserFromState(_this14.user._id);

            _this14.notificationService.text = 'Пользователь удален!';
            _this14.notificationService.showBox = 'on';

            _this14.router.navigate(['/users']);
          }, function (error) {
            _this14.notificationService.text = error.error.message;
            _this14.notificationService.colorError = true;
            _this14.notificationService.showBox = 'on';
            _this14.userService.deleting = false;

            _this14.notificationService.offShow();
          }, function () {
            _this14.userService.deleting = false;
      ...
      _createClass(UsersComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userService.getUsers().subscribe(function (users) {
            _this15.userService.users = users;
          }, function (error) {
            console.log(error.error.message);
            _this15.userService.loading = false;
          }, function () {
            _this15.userService.loading = false;
          });
        }
